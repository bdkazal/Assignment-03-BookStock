...
@section('page_subheading', 'Manage your authors')
        ...
        <table class="w-full">
            <thead class="bg-gray-50 border-b">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Bio</th>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4 text-sm text-gray-700">{{ $author->id }}</td>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-600">
                        ...
                        $bio = $author->bio ?? '';
                        @endphp
                        {{ $bio ? \Illuminate\Support\Str::limit($bio, 80) : '—' }}
                    </td>

                    <td class="px-6 py-4 text-sm text-gray-600">
                        {{ $author->created_at ? \Carbon\Carbon::parse($author->created_at)->format('Y-m-d') : '—' }}
                    </td>
