...
<header class="bg-white shadow-sm sticky top-0 z-20 -mx-6 lg:-mx-8 px-6 lg:px-8 py-4">
    <div class="flex items-center justify-between">
        <div class="flex items-start gap-4">
            ...
            <div>
                <h1 class="text-xl font-bold text-gray-900">Edit Book</h1>
            ...
            <div class="p-6 space-y-8">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-[120px_1fr] gap-6 items-start">
                        ...
                        <div class="w-[120px] h-[160px] rounded-xl border border-gray-200 bg-gray-50 flex items-center justify-center overflow-hidden">
                            ...
                            <img id="coverPreview"
                                src="{{ $coverUrl ?? '' }}"
                                class="{{ $coverUrl ? '' : 'hidden' }} w-full h-full object-cover"
                                alt="Cover Preview" />

                            <div id="coverPlaceholder" class="{{ $coverUrl ? 'hidden' : '' }} text-gray-300">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        {{-- dropzone --}}
                        <div>
                            <label id="dropzone" for="coverInput"
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                        class="w-full rounded-xl border border-gray-300 px-4 py-3 bg-white
                                     focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('description', $book->description) }}</textarea>
                    @error('description')
                    <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                    @enderror
                </div>
